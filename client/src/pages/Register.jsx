      ...
      <div className="flex items-center justify-center px-6 py-12 relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-mono text-teal bg-teal/10 border border-teal/30 px-2.5 py-1 rounded-full font-medium">
              Free Account
            </span>
          </div>

          <h2 className="font-display text-3xl font-bold text-ink tracking-tight">Create your account</h2>
          <p className="text-inkdim mt-2 text-sm">Start instant encrypted rooms in under a minute.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <button
              type="submit"
              disabled={busy}
              className="btn-primary w-full py-3 text-sm font-semibold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 group mt-2"
            >
              <span>{busy ? "Creating account…" : "Create Free Account"}</span>
          ...
          <div className="mt-8 pt-6 border-t border-line/50 text-center">
            <p className="text-inkdim text-sm">
              ...
              <Link to="/login" className="text-amber font-medium hover:underline inline-flex items-center gap-1">
                Sign in
              </Link>
            </p>
          </div>
